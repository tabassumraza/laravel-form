      ...
      <form action="{{url('registersub')}}">
        ...
        <div class="item">
          ...
          <div class="city-item">
            ...
            <input type="text" name="regionname" placeholder="Region" />
        ...
        <div class="item">
          ...
          <input type="text" name="typeOFproblem" required/>
        ...
        <div class="item">
          ...
          <textarea name='complain' rows="5"></textarea>
        </div>
        <div class="btn-block">
